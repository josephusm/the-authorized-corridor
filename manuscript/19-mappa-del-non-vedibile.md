...
Il caso Boeing mostrava che il corridoio può cucire mercato, certificazione, training, interfaccia e fiducia fino a rendere il pilota reale un residuo del modello. Knight Capital mostrava lo stesso disastro in forma accelerata: il segnale c'è, le email ci sono, il sistema brucia prima che la leva diventi leva. Hormuz e il banco rinnovi spostavano il problema sul passaggio: non transito concesso, ma dipendenza dalla gola che decide quando devi tornare valido. La sunyata, infine, ricordava che dissolvere le categorie non basta quando il potere possiede le pompe della fluidità.

La lezione comune non è “servono più procedure”. A volte sì, ma detta così è minestra. La lezione è più precisa: una procedura conta solo se cade nel punto in cui il mondo viene tagliato. Sensore, tempo, interfaccia, leva. Voce, record, ricevuta, correzione. Modifica, autore, data, motivo. Costo, rollback, foro. Se questi pezzi restano su superfici diverse — uno nella piazza, uno nel log, uno nel cruscotto del proprietario, uno nel tribunale postumo — il corridoio può continuare a sembrare giusto mentre lavora contro la possibilità stessa di contestarlo.
...
Questi quattro punti non fanno una salvezza. Fanno una disciplina. Guardare il sensore prima della decisione, il tempo prima dell'evento, l'interfaccia prima della scelta, la leva prima della promessa. Poi fare il lavoro meno elegante: chiedere se la voce entra nello stesso substrato del record, se la ricevuta morde lo stesso atto, se la cadenza apre davvero standing d'interruzione, se il calore modifica un diff o consola soltanto chi resta fuori.
